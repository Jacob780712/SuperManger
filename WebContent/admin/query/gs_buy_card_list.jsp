...
<html>
	...
	<body onload="init()">
		<form name="frmPage" id="queryFrom" action="gsBuyCard.jhtml" method="post">
			<div>
				<div align="left">
					您现在的位置：查询统计 &gt;&gt;公司购卡统计
				</div>
				...
				<table class="table_a marginb10" id="tab" width="90%">
					...
					<c:forEach var="item" items="${page.result}" varStatus="status">
						<tr>
							...
							<td align="center">
								<fmt:formatNumber value="${item.all_pay_amount/100}" pattern="##0.00"/>
							</td>
							<td align="center">
								<fmt:formatNumber value="${item.all_bussiness_amount/100}" pattern="##0.00"/>
							</td>
						</tr>
					</c:forEach>
				</table>
